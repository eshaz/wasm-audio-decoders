...
## Installing
* Install from [NPM](https://www.npmjs.com/package/@wasm-audio-decoders/aac).
...
* Or download the [build](https://github.com/eshaz/wasm-audio-decoders/tree/main/src/aac/dist) and include it as a script.
  ```html
...
1. Begin decoding AAC data. ADTS and ADIF streams are detected automatically.
