...
z AÍp\0NHJê´ªØ^U
Iwu¸öôú!3å6³âVq£³¹´RN£%y10º:p#\:J:b9Hµ7h_:¢I9 _¼µV,þ<`});var d={a:l};this.H=t=>{i.H(n,t)},this.M=()=>i.M(n),this.instantiate=()=>(this.M().then(i=>WebAssembly.instantiate(i,d)).then(i=>{const s=i.exports;var h;(i=>{o=i.i,a=i.j,c=i.k,I=i.l,u=i.m,y=i.o})(s),h=(H=s.g).buffer,e=new Uint8Array(h),new BigInt64Array(h),new BigUint64Array(h),(i=>{i.h()})(s),t()}),this.ready=new Promise(i=>{t=i}).then(()=>{this.O=H.buffer,this.v=a,this.free=u,this.R=o,this._=c,this.q=I}),this)}function M(i={}){M.errors||Object.defineProperties(M,{errors:{value:new Map([[-1,"OPUS_BAD_ARG: One or more invalid/out of range arguments"],[-2,"OPUS_BUFFER_TOO_SMALL: Not enough bytes allocated in the buffer"],[-3,"OPUS_INTERNAL_ERROR: An internal error was detected"],[-4,"OPUS_INVALID_PACKET: The compressed data passed is corrupted"],[-5,"OPUS_UNIMPLEMENTED: Invalid/unsupported request number"],[-6,"OPUS_INVALID_STATE: An encoder or decoder structure is invalid or already freed"],[-7,"OPUS_ALLOC_FAIL: Memory allocation has failed"]])}}),this.K=()=>new this.C(this).instantiate(this.ii,this.ti).then(i=>{this.ei=i,this.Hi=0,this.si=0,this.hi=0,this.ri=this.ei.U(this.ni,Uint8Array),this.Mi=this.ei.U(this.oi*this.ai,Float32Array);const t=this.ei.U(this.ci,Uint8Array);t.F.set(this.Ii),this.ui=this.ei.I.R(this.yi,this.ci,this.li,this.di,t.Y,this.pi,this.mi)}),Object.defineProperty(this,"ready",{enumerable:!0,get:()=>this.fi}),this.reset=()=>(this.free(),this.K()),this.free=()=>{this.ei.free(),this.ei.I.q(this.ui),this.ei.I.free(this.ui)},this.Ji=i=>{if(!(i instanceof Uint8Array))throw Error("Data to decode must be Uint8Array. Instead got "+typeof i);this.ri.F.set(i);let t,e=this.ei.I._(this.ui,this.ri.Y,i.length,this.Mi.Y);return e<0&&(t="libopus "+e+" "+(M.errors.get(e)||"Unknown Error"),console.error(t),e=0),{outputBuffer:this.ei.P(this.Mi.F,this.oi,e),samplesDecoded:e,error:t}},this.decodeFrame=i=>{let t=[];const e=this.Ji(i);return e.error&&this.ei.D(t,e.error,i.length,this.hi,this.Hi,this.si),this.hi++,this.Hi+=i.length,this.si+=e.samplesDecoded,this.C.W(t,[e.outputBuffer],this.oi,e.samplesDecoded,this.yi)},this.decodeFrames=i=>{let t=[],e=[],H=0,s=0;for(;s<i.length;){const h=i[s++],r=this.Ji(h);t.push(r.outputBuffer),H+=r.samplesDecoded,r.error&&this.ei.D(e,r.error,h.length,this.hi,this.Hi,this.si),this.hi++,this.Hi+=h.length,this.si+=r.samplesDecoded}return this.C.W(e,t,this.oi,H,this.yi)},this.bi=M.G,this.C=M.V||s,this.ii=M.$||n,this.ti=M.module;const t=i=>"number"==typeof i,e=i.sampleRate,H=i.channels,h=i.streamCount,r=i.coupledStreamCount,o=i.channelMappingTable,a=i.preSkip,c=i.forceStereo?1:0;if(H>2&&(!t(h)||!t(r)||!Array.isArray(o)))throw Error("Invalid Opus Decoder Options for multichannel decoding.");return this.yi=[8e3,12e3,16e3,24e3,48e3].includes(e)?e:48e3,this.ci=t(H)?H:2,this.li=t(h)?h:1,this.di=t(r)?r:this.ci-1,this.Ii=o||(2===this.ci?[0,1]:[0]),this.pi=a||0,this.mi=H<=8&&2!=H?c:0,this.ni=3840*this.ci,this.ai=5760,this.oi=this.mi?2:this.ci,this.fi=this.K(),this}class o extends h{constructor(i){super(i,"opus-decoder",M,n)}async decodeFrame(i){return this.X("decodeFrame",i)}async decodeFrames(i){return this.X("decodeFrames",i)}}r(M,"OpusDecoder"),r(o,"OpusDecoderWebWorker"),i.OpusDecoder=M,i.OpusDecoderWebWorker=o},"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("@eshaz/web-worker")):"function"==typeof define&&define.amd?define(["exports","@eshaz/web-worker"],t):t((i="undefined"!=typeof globalThis?globalThis:i||self)["opus-decoder"]={},i.Worker);
