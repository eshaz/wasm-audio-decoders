...
æfÆùmÅq¾¹É;³yK³;+ÖÇíÉæ= vÔÓ£	7Çíq= ¥Ê½""=Mé)= ¸z`});var b={a:g};this.u=i=>{t.u(He,i)},this.H=()=>t.H(He),this.instantiate=()=>(this.H().then((t=>WebAssembly.instantiate(t,b))).then((t=>{const r=t.exports;var n;(t=>{d=t.l,f=t.m,p=t.n,y=t.o,I=t.p,m=t.r})(r),n=(e=r.j).buffer,i=new Uint8Array(n),s=new Uint32Array(n),new BigInt64Array(n),new BigUint64Array(n),(t=>{t.k()})(r),h()})),this.ready=new Promise((t=>{h=t})).then((()=>{this.$=e.buffer,this.O=f,this.free=d,this.Ji=p,this.Ui=y,this.Ci=I})),this)}function de(){return this.xi=()=>(new this.Si).instantiate(this.ki,this.Oi).then((t=>{this.Fi=t,this.Ti=0,this.Vi=0,this.yi=0,this.Li=this.Fi.S(1,Uint32Array),this.Mi=this.Fi.S(1,Uint32Array),this.$i=this.Fi.S(1,Uint32Array),this.Di=this.Fi.S(1,Uint32Array),this.Bi=this.Fi.S(1,Uint32Array),this.Wi=this.Fi.S(1,Uint32Array),this.Ri=this.Fi.S(1,Uint32Array),this._i=this.Fi.S(1,Uint32Array),this.Ni=this.Fi.I.Ji(this.Li.T,this.Mi.T,this.$i.T,this.Di.T,this.Bi.T,this.Wi.T,this.Ri.T,this._i.T)})),Object.defineProperty(this,"ready",{enumerable:!0,get:()=>this.ji}),this.reset=()=>(this.free(),this.xi()),this.free=()=>{this.Fi.I.Ui(this.Ni),this.Fi.free()},this.qi=t=>{if(!(t instanceof Uint8Array))throw Error("Data to decode must be Uint8Array. Instead got "+typeof t);const i=this.Fi.S(t.length,Uint8Array,!1);i.L.set(t),this.Fi.I.Ci(this.Ni,i.T,i.V);let s,e=[];this.Ri.L[0]&&e.push("Error: "+this.Fi.D(this.Ri.L[0])),this._i.L[0]&&e.push("State: "+this.Fi.D(this._i.L[0])),e.length&&(s=e.join("; "),console.error("@wasm-audio-decoders/flac: \n\t"+e.join("\n\t")));const r=new Float32Array(this.Fi.I.$,this.Bi.L[0],this.Wi.L[0]),n={error:s,outputBuffer:this.Fi.C(r,this.Li.L[0],this.Di.L[0]),samplesDecoded:this.Di.L[0]};return this.Fi.I.free(this.Bi.L[0]),this.Wi.L[0]=0,this.Di.L[0]=0,n},this.decodeFrames=t=>{let i=[],s=[],e=0;for(let r=0;r<t.length;r++){let n=0;const h=t[r];for(;n<h.length;){const t=h.subarray(n,n+this.Ei);n+=t.length;const r=this.qi(t);i.push(r.outputBuffer),e+=r.samplesDecoded,r.error&&this.Fi.B(s,r.error,h.length,this.yi,this.Ti,this.Vi),this.Ti+=h.length,this.Vi+=r.samplesDecoded}this.yi++}return this.Si.J(s,i,this.Li.L[0],e,this.Mi.L[0],this.$i.L[0])},this.Xi=de._,this.Si=de.W||r,this.ki=de.R||He,this.Oi=de.module,this.Ei=524280,this.ji=this.xi(),this}const fe=Symbol(),pe=Symbol(),ye=Symbol(),Ie=Symbol(),me=Symbol(),ge=Symbol(),be=Symbol(),Me=Symbol();class we{constructor(){this.qt=t=>{if("flac"!==t)throw Error("@wasm-audio-decoders/flac does not support this codec "+t)},new r,this[be](),this[fe](de)}[be](){this[ge]=me,this[Me]=0,this.ct=null}[pe](t){if(!this.ct&&t.length>=4){let i="audio/";79!==t[0]||103!==t[1]||103!==t[2]||83!==t[3]?(i+="flac",this[ge]=ye):(i+="ogg",this[ge]=Ie),this.ct=new oe(i,{ni:this.qt,li:!1})}}[fe](t){if(this.Ni){const t=this.Ni;t.ready.then((()=>t.free()))}this.Ni=new t,this.ji=this.Ni.ready}[ye](t){return this.Ni.decodeFrames(t.map((t=>t[le]||t)))}[Ie](t){const i=t.map((t=>t[ae].map((t=>t[le])))).flat(),s=this.Ni.decodeFrames(i),e=t[t.length-1];if(e&&e[ce]){const t=this[Me]-e[ue];if(t>0){for(let i=0;i<s.channelData.length;i++)s.channelData[i]=s.channelData[i].subarray(0,s.samplesDecoded-t);s.samplesDecoded-=t}}return this[Me]+=s.samplesDecoded,s}[me](){return r.A([],[],0,0,0)}get ready(){return this.ji}async reset(){return this[be](),this.Ni.reset()}free(){this.Ni.free()}async decode(t){return this[ge]===me&&this[pe](t),this[this[ge]]([...this.ct.pi(t)])}async flush(){const t=this[this[ge]]([...this.ct.flush()]);return await this.reset(),t}async decodeFile(t){this[pe](t);const i=this[this[ge]]([...this.ct.parseAll(t)]);return await this.reset(),i}async decodeFrames(t){return this[ye](t)}}class Pe extends n{constructor(t){super(t,"flac-decoder",de,He)}async decodeFrames(t){return this.X("decodeFrames",t)}}class Ae extends we{constructor(){super(),super[fe](Pe)}async free(){super.free()}terminate(){this.Ni.terminate()}}h(we,"FLACDecoder"),h(Ae,"FLACDecoderWebWorker"),t.FLACDecoder=we,t.FLACDecoderWebWorker=Ae},"object"==typeof exports&&"undefined"!=typeof module?i(exports,require("@eshaz/web-worker")):"function"==typeof define&&define.amd?define(["exports","@eshaz/web-worker"],i):i((t="undefined"!=typeof globalThis?globalThis:t||self)["flac-decoder"]={},t.Worker);
