            ...
            return new Promise((resolve) => {
              ...
              WASMAudioDecoderCommon.puffCompiled
                ...
                .then((instance) => {
                  ...
                  heapPos += source.length;

                  // set source length
                  const sourceLengthPtr = heapPos;
                  heapView.setUint32(sourceLengthPtr, source.length);
