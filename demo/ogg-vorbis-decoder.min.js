...
cAë¢þÍÍ­ý×ß'$|ð÷= È8a7ç^oÚ~Ò;hTÐ¸Ô£|¸Øÿ£2±õRØg mãq' lë§ nái@G½0%ä4³ü¡x4|Î¥VýyGüo¾ ö÷¹¾ÂGOË`});var h,o,a,l,c,u,d,U={a:{b:t=>Math.atan(t),a:t=>Math.cos(t),d:t=>Math.exp(t),e:t=>Math.log(t),f:(t,s)=>Math.pow(t,s),c:t=>Math.sin(t),h(t,s,e){r.copyWithin(t,s,s+e)},g(t){r.length,(t=>{throw"OOM"})()}}};this.u=s=>{t.u(ci,s)},this.U=()=>t.U(ci),this.instantiate=()=>(this.U().then((t=>WebAssembly.instantiate(t,U))).then((t=>{var e,i=t.exports;h=i.k,o=i.l,a=i.m,l=i.n,c=i.o,u=i.p,d=i.q,i.r,e=i.i.buffer,n=e,r=new Uint8Array(e),(t=>{t.j()})(i),s()})),this.ready=new Promise((t=>{s=t})).then((()=>{this.V=n,this.D=o,this.free=d,this.Gs=h,this.Ns=a,this.Vs=l,this.zs=c,this.Js=u})),this)}function ui(){return this.Ws=()=>(new this.Xs).instantiate(this.Is,this.Zs).then((t=>{this.Fs=t,this.Ys=this.Fs.H(this.qs,Uint8Array),this._s=!0,this.te=this.Fs.H(1,Uint32Array),this.se=this.Fs.H(1,Uint32Array),this.ee=this.Fs.H(1,Uint32Array),this.Hs=this.Fs.H(1,Uint32Array),this.ie=this.Fs.H(1,Uint32Array),this.re=this.Fs.H(256,Uint32Array),this.ne=this.Fs.H(1,Int32Array),this.Ts=0,this.he=0,this.oe=0,this.ae=this.Fs.L.Gs(this.Ys.R,this.te.R,this.se.R,this.ee.R,this.Hs.R,this.ie.R,this.re.R,this.ne.R,256)})),Object.defineProperty(this,"ready",{$:!0,get:()=>this.le}),this.reset=()=>(this.free(),this.Ws()),this.free=()=>{this.Fs.L.Js(this.ae),this.Fs.free()},this.sendSetupHeader=t=>{this.Ys.N.set(t),this.te.N[0]=t.length,this.Fs.L.Ns(this.ae,this._s),this._s=!1},this.initDsp=()=>{this.Fs.L.Vs(this.ae)},this.decodePackets=t=>{let s=[],e=0,i=[];for(let r=0;r<t.length;r++){const n=t[r];this.Ys.N.set(n),this.te.N[0]=n.length,this.Fs.L.zs(this.ae);const h=this.ie.N[0],o=[],a=new Uint32Array(this.Fs.L.V,this.se.N[0],this.ee.N[0]);for(let t=0;t<this.ee.N[0];t++){const s=new Float32Array(h);s.set(new Float32Array(this.Fs.L.V,a[t],h)),o.push(s)}s.push(o),e+=h,this.Ts++,this.he+=n.length,this.oe+=h;for(let t=0;t<this.ne.N;t+=2)i.push({message:this.Fs.J(this.re.N[t])+" "+this.Fs.J(this.re.N[t+1]),frameLength:n.length,frameNumber:this.Ts,inputBytes:this.he,outputSamples:this.oe});this.ne.N[0]=0}return this.Xs.T(i,s,this.ee.N[0],e,this.Hs.N[0],16)},this.ce=ui.F,this.Xs=ui.X||e,this.Is=ui.I||ci,this.Zs=ui.Z,this.qs=131072,this.le=this.Ws(),this}const di=Symbol();class Ui{constructor(){this.os=t=>{if("vorbis"!==t)throw Error("@wasm-audio-decoders/ogg-vorbis does not support this codec "+t)},new e,this.Ws(),this[di](ui)}Ws(){this.ue=!0,this.Lt=new ii("audio/ogg",{Ms:this.os,gs:!1})}[di](t){if(this.ae){const t=this.ae;t.ready.then((()=>t.free()))}this.ae=new t,this.le=this.ae.ready}get ready(){return this.le}async reset(){return this.Ws(),this.ae.reset()}free(){this.ae.free()}async Ue(t){const s=[];for(let e=0;e<t.length;e++){const i=t[e];if(this.ue)if(0===i[li])this.ae.sendSetupHeader(i[ni]);else if(i[li]>1&&this.ue){const t=i[ri][0][hi];this.ae.sendSetupHeader(t[oi]),this.ae.sendSetupHeader(t[ai]),this.ae.initDsp(),this.ue=!1}s.push(...i[ri].map((t=>t[ni])))}return this.ae.decodePackets(s)}async decode(t){return this.Ue([...this.Lt.Cs(t)])}async flush(){const t=this.Ue([...this.Lt.flush()]);return await this.reset(),t}async decodeFile(t){const s=this.Ue([...this.Lt.parseAll(t)]);return await this.reset(),s}}class fi extends i{constructor(t){super(t,"ogg-vorbis-decoder",ui,ci)}async sendSetupHeader(t){return this.tt("sendSetupHeader",t)}async initDsp(){return this.tt("initDsp")}async decodePackets(t){return this.tt("decodePackets",t)}}class pi extends Ui{constructor(){super(),super[di](fi)}async free(){super.free()}terminate(){this.ae.terminate()}}r(Ui,"OggVorbisDecoder"),r(pi,"OggVorbisDecoderWebWorker"),t.OggVorbisDecoder=Ui,t.OggVorbisDecoderWebWorker=pi},"object"==typeof exports&&"undefined"!=typeof module?s(exports,require("@eshaz/web-worker")):"function"==typeof define&&define.amd?define(["exports","@eshaz/web-worker"],s):s((t="undefined"!=typeof globalThis?globalThis:t||self)["ogg-vorbis-decoder"]={},t.Worker);
