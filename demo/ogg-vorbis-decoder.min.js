...
cAë¢þÍÍ­ý×ß'$|ð÷= È8a7ç^oÚ~Ò;hTÐ¸Ô£|¸Øÿ£2±õRØg mãq' lë§ nái@G½0%ä4³ü¡x4|Î¥VýyGüo¾ ö÷¹¾ÂGOË`});var h,a,o,c,l,d,u,U={a:{b:t=>Math.atan(t),a:t=>Math.cos(t),d:t=>Math.exp(t),e:t=>Math.log(t),f:(t,e)=>Math.pow(t,e),c:t=>Math.sin(t),h(t,e,s){r.copyWithin(t,e,e+s)},g(t){r.length,(t=>{throw"OOM"})()}}};this.u=e=>{t.u(Yt,e)},this.U=()=>t.U(Yt),this.instantiate=()=>(this.U().then((t=>WebAssembly.instantiate(t,U))).then((t=>{var s,i=t.exports;h=i.k,a=i.l,o=i.m,c=i.n,l=i.o,d=i.p,u=i.q,i.r,s=i.i.buffer,n=s,r=new Uint8Array(s),(t=>{t.j()})(i),e()})),this.ready=new Promise((t=>{e=t})).then((()=>{this.G=n,this.H=a,this.N=u,this.Ws=h,this.Xs=o,this.Is=c,this.Zs=l,this.Ys=d})),this)}function qt(){return this.qs=()=>(new this._s).instantiate(this.ti,this.ei).then((t=>{this.si=t,this.ii=this.si.$(this.ri,Uint8Array),this.ni=!0,this.hi=this.si.$(1,Uint32Array),this.ai=this.si.$(1,Uint32Array),this.oi=this.si.$(1,Uint32Array),this.Gs=this.si.$(1,Uint32Array),this.ci=this.si.$(1,Uint32Array),this.li=this.si.$(256,Uint32Array),this.di=this.si.$(1,Int32Array),this.Ks=0,this.ui=0,this.Ui=0,this.fi=this.si.L.Ws(this.ii.R,this.hi.R,this.ai.R,this.oi.R,this.Gs.R,this.ci.R,this.li.R,this.di.R,256)})),Object.defineProperty(this,"ready",{O:!0,get:()=>this.pi}),this.reset=()=>(this.free(),this.qs()),this.free=()=>{this.si.L.Ys(this.fi),this.si.free()},this.sendSetupHeader=t=>{this.ii.V.set(t),this.hi.V[0]=t.length,this.si.L.Xs(this.fi,this.ni),this.ni=!1},this.initDsp=()=>{this.si.L.Is(this.fi)},this.decodePackets=t=>{let e=[],s=0,i=[];for(let r=0;r<t.length;r++){const n=t[r];this.ii.V.set(n),this.hi.V[0]=n.length,this.si.L.Zs(this.fi);const h=this.ci.V[0],a=[],o=new Uint32Array(this.si.L.G,this.ai.V[0],this.oi.V[0]);for(let t=0;t<this.oi.V[0];t++){const e=new Float32Array(h);e.set(new Float32Array(this.si.L.G,o[t],h)),a.push(e)}e.push(a),s+=h,this.Ks++,this.ui+=n.length,this.Ui+=h;for(let t=0;t<this.di.V;t+=2)i.push({message:this.si.J(this.li.V[t])+" "+this.si.J(this.li.V[t+1]),frameLength:n.length,frameNumber:this.Ks,inputBytes:this.ui,outputSamples:this.Ui});this.di.V[0]=0}return this._s.T(i,e,this.oi.V[0],s,this.Gs.V[0],16)},this.mi=qt.Z,this._s=qt.W||s,this.ti=qt.X||Yt,this.ei=qt.I,this.ri=131072,this.pi=this.qs(),this}const _t=Symbol();class te{constructor(){this.ws=t=>{if("vorbis"!==t)throw Error("@wasm-audio-decoders/ogg-vorbis does not support this codec "+t)},new s,this.qs(),this[_t](qt)}qs(){this.Mi=!0,this.Mt=new Zt("audio/ogg",{Os:this.ws,Cs:!1})}[_t](t){if(this.fi){const t=this.fi;t.ready.then((()=>t.free()))}this.fi=new t,this.pi=this.fi.ready}get ready(){return this.pi}async reset(){return this.qs(),this.fi.reset()}free(){this.fi.free()}async bi(t){const e=[];for(let s=0;s<t.length;s++){const i=t[s];if(this.Mi)if(0===i.Be)this.fi.sendSetupHeader(i.data);else if(i.Be>1&&this.Mi){const t=i.Oe[0].Bt;this.fi.sendSetupHeader(t.cs),this.fi.sendSetupHeader(t.ls),this.fi.initDsp(),this.Mi=!1}e.push(...i.Oe.map((t=>t.data)))}return this.fi.decodePackets(e)}async decode(t){return this.bi([...this.Mt.Rs(t)])}async flush(){const t=this.bi([...this.Mt.flush()]);return await this.reset(),t}async decodeFile(t){const e=this.bi([...this.Mt.parseAll(t)]);return await this.reset(),e}}class ee extends i{constructor(t){super(t,"ogg-vorbis-decoder",qt,Yt)}async sendSetupHeader(t){return this.tt("sendSetupHeader",t)}async initDsp(){return this.tt("initDsp")}async decodePackets(t){return this.tt("decodePackets",t)}}class se extends te{constructor(){super(),super[_t](ee)}async free(){super.free()}}r(te,"OggVorbisDecoder"),r(se,"OggVorbisDecoderWebWorker"),t.OggVorbisDecoder=te,t.OggVorbisDecoderWebWorker=se},"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("@eshaz/web-worker")):"function"==typeof define&&define.amd?define(["exports","@eshaz/web-worker"],e):e((t="undefined"!=typeof globalThis?globalThis:t||self)["ogg-vorbis-decoder"]={},t.Worker);
