...
¿Íh¯¿óäÕº?Æd§}òLã+ %B÷¬ÿÈeaÁö¬7kýÕQPÊ¹«M~>sFw<ª"A1U!ýÃþöÈ|e¬e©æqob)ÂãÒ¾ûf/pCqH3HEôöt6?ºÜGæëmËËÀ£= sO6©ÉM´K¤GÇS3]YáöuöJ±52wÛ)zë*^!Ç)/CCMN_3lËÅ²]=}Î«kD=}±(Àö¥ûóPÅH¸°ÎVO,7ºP.Ó3WGØÄ¡Ç±§]XlX(æÒLÆòx=}¢´-ÑB®f8q³ÈÓùKJÅ£]èl¸$VTb?Ætòjj*Üë¢+= òï¥!§ws).zJ;¤±OÄ-ÙÚY1Ix¹!=My!-(^S=MÙµíUgù3QÐyÒ[áz÷Ñ= [ÜÄ-¹N¨4nÈáTYëªà)îðyk±A¹ØùØºêÞ:"-hIÙNñoaÑJÁØÙ`});var h,o,a,l,c,u,d,U,f=new TextDecoder("utf8"),p={Ns:{},Ws:[null,[],[]],Gs(t,i){var r=p.Ws[t];0===i||10===i?((1===t?s:e)(((t,s,e)=>{for(var i=0;t[i]&&!(i>=NaN);)++i;return f.decode(t.subarray?t.subarray(0,i):new Uint8Array(t.slice(0,i)))})(r)),r.length=0):r.push(i)},Ds:void 0,get:()=>(p.Ds+=4,h[p.Ds-4>>2]),Ks(t){var s=((t,s)=>{if(!t)return"";for(var e=t+void 0,i=t;!(i>=e)&&o[i];)++i;return f.decode(o.subarray(t,i))})(t);return s},Rs:(t,s)=>t},y={d(t,s,e){o.copyWithin(t,s,s+e)},c(t){o.length,(t=>{throw"OOM"})()},b:t=>0,a(t,s,e,i){var r=p.Vs(t),n=p.qs(r,s,e);return h[i>>2]=n,0},e(t,s,e,i,r){}},m={a:y};this.o=s=>{t.o(hi,s)},this.u=()=>t.u(hi),this.instantiate=()=>(this.u().then((t=>WebAssembly.instantiate(t,m))).then((t=>{var s,e=t.exports;l=e.h,c=e.i,u=e.j,d=e.k,U=e.l,e.m,s=e.f.buffer,a=s,h=new Int32Array(s),o=new Uint8Array(s),(t=>{t.g()})(e),i()})),this.ready=new Promise((t=>{i=t})).then((()=>{this.P=a,this.B=c,this.free=l,this.zs=u,this.Hs=d,this.Qs=U})),this)}function oi(){return this.Zs=()=>(new this.Xs).instantiate(this.te,this.se).then((t=>{this.ee=t,this.ie=0,this.re=0,this.Ss=0,this.ne=this.ee.v(1,Uint32Array),this.Js=this.ee.v(1,Uint32Array),this.he=this.ee.v(1,Uint32Array),this.oe=this.ee.v(1,Uint32Array),this.ae=this.ee.v(1,Uint32Array),this.le=this.ee.v(1,Uint32Array),this.ce=this.ee.v(1,Uint32Array),this.ue=this.ee.v(1,Uint32Array),this.de=this.ee.p.zs(this.ne.J,this.Js.J,this.he.J,this.oe.J,this.ae.J,this.le.J,this.ce.J,this.ue.J)})),Object.defineProperty(this,"ready",{enumerable:!0,get:()=>this.Ue}),this.reset=()=>(this.free(),this.Zs()),this.free=()=>{this.ee.p.Hs(this.de),this.ee.free()},this.fe=t=>{if(!(t instanceof Uint8Array))throw Error("Data to decode must be Uint8Array. Instead got "+typeof t);const s=this.ee.v(t.length,Uint8Array,!1);s.I.set(t),this.ee.p.Qs(this.de,s.J,s.L);let e,i=[];this.ce.I[0]&&i.push("Error: "+this.ee.Y(this.ce.I[0])),this.ue.I[0]&&i.push("State: "+this.ee.Y(this.ue.I[0])),i.length&&(e=i.join("; "),console.error("@wasm-audio-decoders/flac: \n\t"+i.join("\n\t")));const r=new Float32Array(this.ee.p.P,this.ae.I[0],this.le.I[0]),n={error:e,outputBuffer:this.ee.F(r,this.ne.I[0],this.oe.I[0]),samplesDecoded:this.oe.I[0]};return this.ee.p.free(this.ae.I[0]),this.le.I[0]=0,this.oe.I[0]=0,n},this.decodeFrames=t=>{let s=[],e=[],i=0;for(let r=0;r<t.length;r++){let n=0;const h=t[r];for(;n<h.length;){const t=h.subarray(n,n+this.pe);n+=t.length;const r=this.fe(t);s.push(r.outputBuffer),i+=r.samplesDecoded,r.error&&this.ee.N(e,r.error,h.length,this.Ss,this.ie,this.re),this.ie+=h.length,this.re+=r.samplesDecoded}this.Ss++}return this.Xs.O(e,s,this.ne.I[0],i,this.Js.I[0],this.he.I[0])},this.ye=oi.K,this.Xs=oi.W||e,this.te=oi.G||hi,this.se=oi.D,this.pe=524280,this.Ue=this.Zs(),this}const ai=Symbol();class li{constructor(){this.es=t=>{if("flac"!==t)throw Error("@wasm-audio-decoders/flac does not support this codec "+t)},new e,this.Zs(),this[ai](oi)}Zs(){this.Ut=new ri("audio/flac",{ys:this.es,bs:!1})}[ai](t){if(this.de){const t=this.de;t.ready.then((()=>t.free()))}this.de=new t,this.Ue=this.de.ready}get ready(){return this.Ue}async reset(){return this.Zs(),this.de.reset()}free(){this.de.free()}async decode(t){return this.de.decodeFrames([...this.Ut.Cs(t)].map((t=>t[ni])))}async flush(){const t=this.de.decodeFrames([...this.Ut.flush()].map((t=>t[ni])));return await this.reset(),t}async decodeFile(t){const s=this.de.decodeFrames([...this.Ut.parseAll(t)].map((t=>t[ni])));return await this.reset(),s}async decodeFrames(t){return this.de.decodeFrames(t)}}class ci extends i{constructor(t){super(t,"flac-decoder",oi,hi)}async decodeFrames(t){return this.q("decodeFrames",t)}}class ui extends li{constructor(){super(),super[ai](ci)}async free(){super.free()}terminate(){this.de.terminate()}}r(li,"FLACDecoder"),r(ui,"FLACDecoderWebWorker"),t.FLACDecoder=li,t.FLACDecoderWebWorker=ui},"object"==typeof exports&&"undefined"!=typeof module?s(exports,require("@eshaz/web-worker")):"function"==typeof define&&define.amd?define(["exports","@eshaz/web-worker"],s):s((t="undefined"!=typeof globalThis?globalThis:t||self)["flac-decoder"]={},t.Worker);
