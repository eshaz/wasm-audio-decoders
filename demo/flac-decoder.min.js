...
¿Íh¯¿óäÕº?Æd§}òLã+ %B÷¬ÿÈeaÁö¬7kýÕQPÊ¹«M~>sFw<ª"A1U!ýÃþöÈ|e¬e©æqob)ÂãÒ¾ûf/pCqH3HEôöt6?ºÜGæëmËËÀ£= sO6©ÉM´K¤GÇS3]YáöuöJ±52wÛ)zë*^!Ç)/CCMN_3lËÅ²]=}Î«kD=}±(Àö¥ûóPÅH¸°ÎVO,7ºP.Ó3WGØÄ¡Ç±§]XlX(æÒLÆòx=}¢´-ÑB®f8q³ÈÓùKJÅ£]èl¸$VTb?Ætòjj*Üë¢+= òï¥!§ws).zJ;¤±OÄ-ÙÚY1Ix¹!=My!-(^S=MÙµíUgù3QÐyÒ[áz÷Ñ= [ÜÄ-¹N¨4nÈáTYëªà)îðyk±A¹ØùØºêÞ:"-hIÙNñoaÑJÁØÙ`});var h,o,a,l,c,u,d,U,f=new TextDecoder("utf8"),p={Ps:{},Ys:[null,[],[]],js(t,i){var r=p.Ys[t];0===i||10===i?((1===t?s:e)(((t,s,e)=>{for(var i=0;t[i]&&!(i>=NaN);)++i;return f.decode(t.subarray?t.subarray(0,i):new Uint8Array(t.slice(0,i)))})(r)),r.length=0):r.push(i)},Ns:void 0,get:()=>(p.Ns+=4,h[p.Ns-4>>2]),Ws(t){var s=((t,s)=>{if(!t)return"";for(var e=t+void 0,i=t;!(i>=e)&&o[i];)++i;return f.decode(o.subarray(t,i))})(t);return s},Gs:(t,s)=>t},y={d(t,s,e){o.copyWithin(t,s,s+e)},c(t){o.length,(t=>{throw"OOM"})()},b:t=>0,a(t,s,e,i){var r=p.Ds(t),n=p.Ks(r,s,e);return h[i>>2]=n,0},e(t,s,e,i,r){}},m={a:y};this.o=s=>{t.o(ni,s)},this.u=()=>t.u(ni),this.instantiate=()=>(this.u().then((t=>WebAssembly.instantiate(t,m))).then((t=>{var s,e=t.exports;l=e.h,c=e.i,u=e.j,d=e.k,U=e.l,e.m,s=e.f.buffer,a=s,h=new Int32Array(s),o=new Uint8Array(s),(t=>{t.g()})(e),i()})),this.ready=new Promise((t=>{i=t})).then((()=>{this.Y=a,this._=c,this.free=l,this.Rs=u,this.Vs=d,this.qs=U})),this)}function hi(){return this.zs=()=>(new this.Hs).instantiate(this.Qs,this.Zs).then((t=>{this.Xs=t,this.te=0,this.se=0,this.As=0,this.ee=this.Xs.B(1,Uint32Array),this.vs=this.Xs.B(1,Uint32Array),this.ie=this.Xs.B(1,Uint32Array),this.re=this.Xs.B(1,Uint32Array),this.ne=this.Xs.B(1,Uint32Array),this.he=this.Xs.B(1,Uint32Array),this.oe=this.Xs.B(1,Uint32Array),this.ae=this.Xs.B(1,Uint32Array),this.le=this.Xs.p.Rs(this.ee.I,this.vs.I,this.ie.I,this.re.I,this.ne.I,this.he.I,this.oe.I,this.ae.I)})),Object.defineProperty(this,"ready",{F:!0,get:()=>this.ce}),this.reset=()=>(this.free(),this.zs()),this.free=()=>{this.Xs.p.Vs(this.le),this.Xs.free()},this.ue=t=>{if(!(t instanceof Uint8Array))throw Error("Data to decode must be Uint8Array. Instead got "+typeof t);const s=this.Xs.B(t.length,Uint8Array,!1);s.P.set(t),this.Xs.p.qs(this.le,s.I,s.L);let e,i=[];this.oe.P[0]&&i.push("Error: "+this.Xs.N(this.oe.P[0])),this.ae.P[0]&&i.push("State: "+this.Xs.N(this.ae.P[0])),i.length&&(e=i.join("; "),console.error("@wasm-audio-decoders/flac: \n\t"+i.join("\n\t")));const r=new Float32Array(this.Xs.p.Y,this.ne.P[0],this.he.P[0]),n={error:e,outputBuffer:this.Xs.v(r,this.ee.P[0],this.re.P[0]),samplesDecoded:this.re.P[0]};return this.Xs.p.free(this.ne.P[0]),this.he.P[0]=0,this.re.P[0]=0,n},this.decodeFrames=t=>{let s=[],e=[],i=0;for(let r=0;r<t.length;r++){let n=0;const h=t[r];for(;n<h.length;){const t=h.subarray(n,n+this.de);n+=t.length;const r=this.ue(t);s.push(r.outputBuffer),i+=r.samplesDecoded,r.error&&this.Xs.W(e,r.error,h.length,this.As,this.te,this.se),this.te+=h.length,this.se+=r.samplesDecoded}this.As++}return this.Hs.O(e,s,this.ee.P[0],i,this.vs.P[0],this.ie.P[0])},this.Ue=hi.R,this.Hs=hi.G||e,this.Qs=hi.D||ni,this.Zs=hi.K,this.de=524280,this.ce=this.zs(),this}const oi=Symbol();class ai{constructor(){this.rs=t=>{if("flac"!==t)throw Error("@wasm-audio-decoders/flac does not support this codec "+t)},new e,this.zs(),this[oi](hi)}zs(){this.ft=new ii("audio/flac",{Us:this.rs,gs:!1})}[oi](t){if(this.le){const t=this.le;t.ready.then((()=>t.free()))}this.le=new t,this.ce=this.le.ready}get ready(){return this.ce}async reset(){return this.zs(),this.le.reset()}free(){this.le.free()}async decode(t){return this.le.decodeFrames([...this.ft.xs(t)].map((t=>t[ri])))}async flush(){const t=this.le.decodeFrames([...this.ft.flush()].map((t=>t[ri])));return await this.reset(),t}async decodeFile(t){const s=this.le.decodeFrames([...this.ft.parseAll(t)].map((t=>t[ri])));return await this.reset(),s}async decodeFrames(t){return this.le.decodeFrames(t)}}class li extends i{constructor(t){super(t,"flac-decoder",hi,ni)}async decodeFrames(t){return this.H("decodeFrames",t)}}class ci extends ai{constructor(){super(),super[oi](li)}async free(){super.free()}terminate(){this.le.terminate()}}r(ai,"FLACDecoder"),r(ci,"FLACDecoderWebWorker"),t.FLACDecoder=ai,t.FLACDecoderWebWorker=ci},"object"==typeof exports&&"undefined"!=typeof module?s(exports,require("@eshaz/web-worker")):"function"==typeof define&&define.amd?define(["exports","@eshaz/web-worker"],s):s((t="undefined"!=typeof globalThis?globalThis:t||self)["flac-decoder"]={},t.Worker);
