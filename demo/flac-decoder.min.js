...
¿Íh¯¿óäÕº?Æd§}òLã+ %B÷¬ÿÈeaÁö¬7kýÕQPÊ¹«M~>sFw<ª"A1U!ýÃþöÈ|e¬e©æqob)ÂãÒ¾ûf/pCqH3HEôöt6?ºÜGæëmËËÀ£= sO6©ÉM´K¤GÇS3]YáöuöJ±52wÛ)zë*^!Ç)/CCMN_3lËÅ²]=}Î«kD=}±(Àö¥ûóPÅH¸°ÎVO,7ºP.Ó3WGØÄ¡Ç±§]XlX(æÒLÆòx=}¢´-ÑB®f8q³ÈÓùKJÅ£]èl¸$VTb?Ætòjj*Üë¢+= òï¥!§ws).zJ;¤±OÄ-ÙÚY1Ix¹!=My!-(^S=MÙµíUgù3QÐyÒ[áz÷Ñ= [ÜÄ-¹N¨4nÈáTYëªà)îðyk±A¹ØùØºêÞ:"-hIÙNñoaÑJÁØÙ`});var h,a,o,c,d,l,u,U,f=new TextDecoder("utf8"),m={Ws:{},Ds:[null,[],[]],Rs(t,i){var r=m.Ds[t];0===i||10===i?((1===t?e:s)(((t,e,s)=>{for(var i=0;t[i]&&!(i>=NaN);)++i;return f.decode(t.subarray?t.subarray(0,i):new Uint8Array(t.slice(0,i)))})(r)),r.length=0):r.push(i)},Gs:void 0,get:()=>(m.Gs+=4,h[m.Gs-4>>2]),Hs(t){var e=((t,e)=>{if(!t)return"";for(var s=t+void 0,i=t;!(i>=s)&&a[i];)++i;return f.decode(a.subarray(t,i))})(t);return e},Vs:(t,e)=>t},p={a:{d(t,e,s){a.copyWithin(t,e,e+s)},c(t){a.length,(t=>{throw"OOM"})()},b:t=>0,a(t,e,s,i){var r=m.Ks(t),n=m.qs(r,e,s);return h[i>>2]=n,0},e(t,e,s,i,r){}}};this.o=e=>{t.o(Qt,e)},this.u=()=>t.u(Qt),this.instantiate=()=>(this.u().then((t=>WebAssembly.instantiate(t,p))).then((t=>{var e,s=t.exports;c=s.h,d=s.i,l=s.j,u=s.k,U=s.l,s.m,e=s.f.buffer,o=e,h=new Int32Array(e),a=new Uint8Array(e),(t=>{t.g()})(s),i()})),this.ready=new Promise((t=>{i=t})).then((()=>{this.P=o,this.B=d,this._free=c,this._create_decoder=l,this._destroy_decoder=u,this._decode_frame=U})),this)}function Zt(){return this.Qs=()=>(new this.Zs).instantiate(this.Xs,this.ti).then((t=>{this.ei=t,this.si=0,this.ii=0,this._s=0,this.ri=this.ei.C(1,Uint32Array),this.Ps=this.ei.C(1,Uint32Array),this.ni=this.ei.C(1,Uint32Array),this.hi=this.ei.C(1,Uint32Array),this.ai=this.ei.C(1,Uint32Array),this.oi=this.ei.C(1,Uint32Array),this.ci=this.ei.C(1,Uint32Array),this.di=this.ei.C(1,Uint32Array),this.li=this.ei.p._create_decoder(this.ri._,this.Ps._,this.ni._,this.hi._,this.ai._,this.oi._,this.ci._,this.di._)})),Object.defineProperty(this,"ready",{O:!0,get:()=>this.ui}),this.reset=()=>(this.free(),this.Qs()),this.free=()=>{this.ei.p._destroy_decoder(this.li),this.ei.free()},this.Ui=t=>{if(!(t instanceof Uint8Array))throw Error("Data to decode must be Uint8Array. Instead got "+typeof t);const e=this.ei.C(t.length,Uint8Array,!1);e.L.set(t),this.ei.p._decode_frame(this.li,e._,e.I);let s,i=[];this.ci.L[0]&&i.push("Error: "+this.ei.Y(this.ci.L[0])),this.di.L[0]&&i.push("State: "+this.ei.Y(this.di.L[0])),i.length&&(s=i.join("; "),console.error("@wasm-audio-decoders/flac: \n\t"+i.join("\n\t")));const r=new Float32Array(this.ei.p.P,this.ai.L[0],this.oi.L[0]),n={error:s,outputBuffer:this.ei.v(r,this.ri.L[0],this.hi.L[0]),samplesDecoded:this.hi.L[0]};return this.ei.p._free(this.ai.L[0]),this.oi.L[0]=0,this.hi.L[0]=0,n},this.decodeFrames=t=>{let e=[],s=[],i=0;for(let r=0;r<t.length;r++){let n=0;const h=t[r];for(;n<h.length;){const t=h.subarray(n,n+this.fi);n+=t.length;const r=this.Ui(t);e.push(r.outputBuffer),i+=r.samplesDecoded,r.error&&this.ei.N(s,r.error,h.length,this._s,this.si,this.ii),this.si+=h.length,this.ii+=r.samplesDecoded}this._s++}return this.Zs.$(s,e,this.ri.L[0],i,this.Ps.L[0],this.ni.L[0])},this.mi=Zt.G,this.Zs=Zt.W||s,this.Xs=Zt.D||Qt,this.ti=Zt.R,this.fi=524280,this.ui=this.Qs(),this}const Xt=Symbol();class te{constructor(){this.ps=t=>{if("flac"!==t)throw Error("@wasm-audio-decoders/flac does not support this codec "+t)},new s,this.Qs(),this[Xt](Zt)}Qs(){this.lt=new qt("audio/flac",{xs:this.ps,Os:!1})}[Xt](t){if(this.li){const t=this.li;t.ready.then((()=>t.free()))}this.li=new t,this.ui=this.li.ready}get ready(){return this.ui}async reset(){return this.Qs(),this.li.reset()}free(){this.li.free()}async decode(t){return this.li.decodeFrames([...this.lt.Js(t)].map((t=>t.data)))}async flush(){const t=this.li.decodeFrames([...this.lt.flush()].map((t=>t.data)));return await this.reset(),t}async decodeFile(t){const e=this.li.decodeFrames([...this.lt.parseAll(t)].map((t=>t.data)));return await this.reset(),e}async decodeFrames(t){return this.li.decodeFrames(t)}}class ee extends i{constructor(t){super(t,"flac-decoder",Zt,Qt)}async decodeFrames(t){return this.K("decodeFrames",t)}}class se extends te{constructor(){super(),super[Xt](ee)}async free(){super.free()}terminate(){this.li.terminate()}}r(te,"FLACDecoder"),r(se,"FLACDecoderWebWorker"),t.FLACDecoder=te,t.FLACDecoderWebWorker=se},"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("@eshaz/web-worker")):"function"==typeof define&&define.amd?define(["exports","@eshaz/web-worker"],e):e((t="undefined"!=typeof globalThis?globalThis:t||self)["flac-decoder"]={},t.Worker);
